...
def prepareResponse(result,user_response):    
    if(questions[user_response] in result):
        ...
        return result[questions[user_response]] 
    else:
        questions.pop(user_response)
        #print('Sorry, refine your question')
        return 'Sorry, refine your question'
...
#flag=True
#print("My name is Robo. I will answer your queries about WCADS. If you want to exit, type Bye!")
        ...
        if(user_response=='thanks' or user_response=='thank you' ):
            ...
            if(greeting(user_response)!=None):
                ...
                if(user_response in CONNECTING_STATMENTS):
                    #print("Do you like my response ?")
                    return "Do you like my response ?"
                elif(user_response in EXCALMAT_STATEMENTS):
                        #print("Thank you, say ok to continue")
                    return "Thank you, say ok to continue"
                
                else :
                    user_response = isQuestionBeenAsked(user_response)
                    if(isNotValidQs(user_response)):                     
                        #print('Please start a conversation about you want to know !!')
                        return 'Please start a conversation about you want to know !!'
                    else:
                        result = response(user_response) 
                        return prepareResponse(result,user_response)                
    else:
        flag=False
        #print("Bye! take care..")
